...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'orc'),
        'USER': os.getenv('DB_USER', 'orc'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'orc'),
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'orc.utils.context_processors.settings',
            ],
...
DEFAULT_FROM_EMAIL = 'orc@example.com'
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    'handlers': {
        ...
        'project': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(LOGGING_DIR, 'orc.log'),
            'formatter': 'verbose',
            'maxBytes': 1024 * 1024 * 10,  # 10 MB
            'backupCount': 10
        },
...
AUTHENTICATION_BACKENDS = [
    'orc.accounts.backends.UserModelEmailBackend',
